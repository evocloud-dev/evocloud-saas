...
A [timoni.sh](http://timoni.sh) module for deploying superset to Kubernetes clusters.
...
```shell
timoni -n default apply superset oci://<container-registry-url>
```
...
```shell
timoni -n default delete superset
```
