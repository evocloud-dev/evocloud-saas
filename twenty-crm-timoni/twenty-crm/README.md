...
A [timoni.sh](http://timoni.sh) module for deploying twenty-crm to Kubernetes clusters.
...
```shell
timoni -n default apply twenty-crm oci://<container-registry-url>
```
...
```shell
timoni -n default delete twenty-crm
```
