...
A [timoni.sh](http://timoni.sh) module for deploying docuseal-timoni to Kubernetes clusters.
...
```shell
timoni -n default apply docuseal-timoni oci://<container-registry-url>
```
...
```shell
timoni -n default delete docuseal-timoni
```
