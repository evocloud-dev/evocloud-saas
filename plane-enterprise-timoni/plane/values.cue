...
services: {
	...
	pi: {
		...
		memoryRequest: "128Mi"
		cpuRequest:    "10m"
		image:         "artifacts.plane.so/makeplane/plane-pi-commercial"
		pullPolicy:    "Always"
		assign_cluster_ip: false
		nodeSelector: {}
		tolerations:  []
...
env: {
	...
	// use_storage_proxy: Set to true to force the API to handle image uploads and retrieval.
	// This ensures images are accessible via http://localhost:8080 even though Minio is internal.
