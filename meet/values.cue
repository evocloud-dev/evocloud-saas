//  Reference: https://github.com/suitenumerique/meet/blob/main/src/helm/meet/values.yaml https://github.com/suitenumerique/meet/blob/main/docs/installation/kubernetes.md
...
values: {
	...
	let _commonEnvVars = {
		...
		AUTHORIZED_TENANTS:       "[{\"id\": \"meet\", \"api_key\": \"password\", \"webhook_url\": \"https://meet.127.0.0.1.nip.io/api/v1.0/recordings/external-process-hook/\", \"webhook_api_key\": \"webhook-password\", \"allowed_push_to_docs\": false}]"
  ...
  "clients": [
    ...
    },
    {
      ...
      "attributes": {
        ...
        "post.logout.redirect.uris": "http://localhost:8070/*##https://meet.127.0.0.1.nip.io/*##http://localhost:3000/*",
...
"""
	...
	minio: {
		...
		caCert: """
-----BEGIN CERTIFICATE-----

S21E
-----END CERTIFICATE-----
"""
		ingress: {
