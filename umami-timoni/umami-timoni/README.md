...
A [timoni.sh](http://timoni.sh) module for deploying umami-timoni to Kubernetes clusters.
...
```shell
timoni -n default apply umami-timoni oci://<container-registry-url>
```
...
```shell
timoni -n default delete umami-timoni
```
