...
A [timoni.sh](http://timoni.sh) module for deploying calcom-timoni to Kubernetes clusters.
...
```shell
timoni -n default apply calcom-timoni oci://<container-registry-url>
```
...
```shell
timoni -n default delete calcom-timoni
```
