...
A [timoni.sh](http://timoni.sh) module for deploying wallabag to Kubernetes clusters.
...
```shell
timoni -n default apply wallabag oci://<container-registry-url>
```
...
```shell
timoni -n default delete wallabag
```
