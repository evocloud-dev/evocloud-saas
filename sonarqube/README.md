...
A [timoni.sh](http://timoni.sh) module for deploying sonarqube to Kubernetes clusters.
...
```shell
timoni -n default apply sonarqube oci://<container-registry-url>
```
...
```shell
timoni -n default delete sonarqube
```
