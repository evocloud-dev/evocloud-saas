...
A [timoni.sh](http://timoni.sh) module for deploying zammad to Kubernetes clusters.
...
```shell
timoni -n default apply zammad oci://<container-registry-url>
```
...
```shell
timoni -n default delete zammad
```
