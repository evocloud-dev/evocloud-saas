...
A [timoni.sh](http://timoni.sh) module for deploying paperless-timoni to Kubernetes clusters.
...
```shell
timoni -n default apply paperless-timoni oci://<container-registry-url>
```
