...
A [timoni.sh](http://timoni.sh) module for deploying opensign to Kubernetes clusters.
...
```shell
timoni -n default apply opensign oci://<container-registry-url>
```
...
```shell
timoni -n default delete opensign
```
