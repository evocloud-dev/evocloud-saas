...
A [timoni.sh](http://timoni.sh) module for deploying hyperswitch-stack to Kubernetes clusters.
...
```shell
timoni -n default apply hyperswitch-stack oci://<container-registry-url>
```
...
```shell
timoni -n default delete hyperswitch-stack
```
