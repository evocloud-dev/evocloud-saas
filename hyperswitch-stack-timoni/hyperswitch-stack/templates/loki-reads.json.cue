...
// loki-reads.json.cue
// This file is a 1:1 migration of src/dashboards/loki-reads.json from the Loki Helm chart.
// It is intended to be used within a Kubernetes ConfigMap for Grafana dashboards.

loki_reads_json: json.Marshal(_loki_reads_json_content)

_loki_reads_json_content: {
	"annotations": {
		"list": []
	}
	"editable":     true
