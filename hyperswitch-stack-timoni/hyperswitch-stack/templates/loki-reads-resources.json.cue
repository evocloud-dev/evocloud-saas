...
// loki-reads-resources.json.cue
// This file is a 1:1 migration of src/dashboards/loki-reads-resources.json from the Loki Helm chart.
// It is intended to be used within a Kubernetes ConfigMap for Grafana dashboards.

loki_reads_resources_json: json.Marshal(_loki_reads_resources_json_content)

_loki_reads_resources_json_content: {
	"annotations": {
		"list": []
	}
	"editable":     true
			...
			"panels": [
				{
					...
					"targets": [
						{
							"expr":           "sum by(pod) (rate(container_cpu_usage_seconds_total{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(backend|ingester|querier|distributor).*\"}[$__rate_interval]))"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "{{pod}}"
							"legendLink":     null
						...
						{
							"expr":           "min(container_spec_cpu_quota{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(backend|ingester|querier|distributor).*\"} / container_spec_cpu_period{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(backend|ingester|querier|distributor).*\"})"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "limit"
							"legendLink":     null
				...
				},
				{
					...
					"targets": [
						{
							"expr":           "max by(pod) (container_memory_working_set_bytes{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(backend|ingester|querier|distributor).*\"})"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "{{pod}}"
							"legendLink":     null
						...
						{
							"expr":           "min(container_spec_memory_limit_bytes{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(backend|ingester|querier|distributor).*\"} > 0)"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "limit"
							"legendLink":     null
				...
				},
				{
					...
					"targets": [
						{
							"expr":           "sum by(pod) (go_memstats_heap_inuse_bytes{cluster=~\"$cluster\", job=~\"($namespace)/(loki|enterprise-logs)-(backend|ingester|querier|distributor)\"})"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "{{pod}}"
							"legendLink":     null
			...
			"panels": [
				{
					...
					"targets": [
						{
							"expr":           "sum by(pod) (rate(container_cpu_usage_seconds_total{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(compactor|gateway|table-manager|index-gateway).*\"}[$__rate_interval]))"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "{{pod}}"
							"legendLink":     null
						...
						{
							"expr":           "min(container_spec_cpu_quota{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(compactor|gateway|table-manager|index-gateway).*\"} / container_spec_cpu_period{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(compactor|gateway|table-manager|index-gateway).*\"})"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "limit"
							"legendLink":     null
				...
				},
				{
					...
					"targets": [
						{
							"expr":           "max by(pod) (container_memory_working_set_bytes{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(compactor|gateway|table-manager|index-gateway).*\"})"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "{{pod}}"
							"legendLink":     null
						...
						{
							"expr":           "min(container_spec_memory_limit_bytes{cluster=~\"$cluster\", namespace=~\"$namespace\", container=\"loki\", pod=~\"(loki|enterprise-logs)-(compactor|gateway|table-manager|index-gateway).*\"} > 0)"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "limit"
							"legendLink":     null
				...
				},
				{
					...
					"targets": [
						{
							"expr":           "sum by(pod) (go_memstats_heap_inuse_bytes{cluster=~\"$cluster\", job=~\"($namespace)/(loki|enterprise-logs)-(compactor|gateway|table-manager|index-gateway)\"})"
							"format":         "time_series"
							"intervalFactor": 2
							"legendFormat":   "{{pod}}"
							"legendLink":     null
