...
// loki-writes-resources.json.cue
// This file is a 1:1 migration of src/dashboards/loki-writes-resources.json from the Loki Helm chart.
// It is intended to be used within a Kubernetes ConfigMap for Grafana dashboards.

loki_writes_resources_json: json.Marshal(_loki_writes_resources_json_content)

_loki_writes_resources_json_content: {
	"annotations": {
		"list": []
	}
	"editable":     true
