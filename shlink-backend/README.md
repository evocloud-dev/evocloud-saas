...
A [timoni.sh](http://timoni.sh) module for deploying shlink-backend to Kubernetes clusters.
...
```shell
timoni -n default apply shlink-backend oci://<container-registry-url>
```
...
```shell
timoni -n default delete shlink-backend
```
