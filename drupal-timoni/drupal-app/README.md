...
A [timoni.sh](http://timoni.sh) module for deploying drupal-app to Kubernetes clusters.
...
```shell
timoni -n default apply drupal-app oci://<container-registry-url>
```
...
```shell
timoni -n default delete drupal-app
```
