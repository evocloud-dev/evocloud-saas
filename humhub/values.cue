...
// Reference: https://github.com/trueforge-org/truecharts/blob/master/charts/stable/humhub/values.yaml
				...
				containers: {
					nginx: {
						...
						env: {
							...
							HUMHUB_REVERSEPROXY_WHITELIST: "10.0.0.0/8;172.16.0.0/16;192.168.1.0/24;localhost;127.0.0.1"
						}
						probes: {
							liveness: {
								enabled: true
