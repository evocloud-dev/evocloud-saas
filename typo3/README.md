...
A [timoni.sh](http://timoni.sh) module for deploying typo3 to Kubernetes clusters.
...
```shell
timoni -n default apply typo3 oci://<container-registry-url>
```
